...
var BitcoinPrice = /** @class */function () {
  function BitcoinPrice(input) {
    var _this = this;
    this.observer = []; //Aquí se guardan las instancias de PriceDisplay
    input.addEventListener("input", function () {
      _this.notify(input.value);
    });
  }
  ...
  BitcoinPrice.prototype.unSubscribe = function (observer) {
    var index = this.observer.findIndex(function (obs) {
      return obs === observer;
    });
...
var display = new PriceDisplay(price); //1 Se crea la instancia de display
//Esta recibe como argumento el valor actual de la etiqueta <em> donde se muestra el texto 
var value = new BitcoinPrice(input); //2 Se crea la instancia de BitcoinPrice
